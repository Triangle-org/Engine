 ...
 *
 * <code>
 *  $guzzle = new support\http\Guzzle(new GuzzleHttp\Client(), [
 *      'verify' => '/path/to/your/certificate.crt',
 *      'headers' => ['User-Agent' => '..']
 *      // 'proxy' => ...
 *  ]);
 *
 *  $adapter = new support\http\Provider\Github($config, $guzzle);
 *
